...
CHECKPOINT_PATH="${HOME}/model/skip_thoughts/pretrained/skip_thoughts_uni_2017_02_02/model.ckpt-501424"#否则报错
...
#报错 raise BadZipfile, "File is not a zip file"
punkt重新下载（python ；import nltk；download punkt）
cd model
